...
public class PresupuestoIngreso {
    private String presupuestoIngresoId;
    ...
    public String getPresupuestoIngresoId() {
        return presupuestoIngresoId;
    }

    public void setPresupuestoIngresoId(String presupuestoIngresoId) {
        this.presupuestoIngresoId = presupuestoIngresoId;
    }
