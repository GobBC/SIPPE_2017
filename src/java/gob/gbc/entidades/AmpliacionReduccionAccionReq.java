 ...
 * @author ugarcia
 */
public class AmpliacionReduccionAccionReq {
    ...
    private String isIngresoPropio;
    
    public AmpliacionReduccionAccionReq(){
        this.isIngresoPropio = new String();
    }
    ...
    public String getTipoMovAmpRed() {
        return tipoMovAmpRed;
    }

    public void setTipoMovAmpRed(String tipoMovAmpRed) {
        this.tipoMovAmpRed = tipoMovAmpRed;
    }
    ...
    public String getIsIngresoPropio() {
        return isIngresoPropio;
    }

    public void setIsIngresoPropio(String isIngresoPropio) {
        this.isIngresoPropio = isIngresoPropio;
    }
