...
<html>
    ...
    <body>
        <div Id="TitProcess"><label >Reporte presupuesto ingreso y egreso<label/></div>
        <div class="col-md-8 col-md-offset-2">
            <div class="botones-menu_bootstrap">
                ...
                <button type="button" class="btnbootstrap btn-Excel" onclick="generarReporteIngresoEgreso('XLS')">
        ...
        <div class="center-div"> 
            <form id='frmActInfoRpt' action="ejecutaReporte/ejecutarReporte.jsp" target="_blank" method="POST">
                <input type="hidden" id="filename" name="filename" value="<%="ingresoEgreso" + File.separatorChar + "rptPresupIngEgr.jasper"%>"/> 
