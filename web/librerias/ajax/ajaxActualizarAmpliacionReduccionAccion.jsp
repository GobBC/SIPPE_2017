<%-- 
    Document   : ajaxActualizarAmpliacionReduccionAccion
...
<%
    ...
    try {
        ...
        /*if (session.getAttribute("accionIdNegativo") != null && !session.getAttribute("accionIdNegativo").equals("")) {
         accionIdNegativo = Integer.parseInt((String) session.getAttribute("accionIdNegativo"));
         }*/
        ...
        /*if (identificador == -1) {
         accionId = ampliacionReduccionBean.getConsecutivoNegativoAccion();
         accionId += accionIdNegativo;
         accionIdNegativo = accionId;
         session.setAttribute("accionIdNegativo", String.valueOf(accionIdNegativo));
         }*/
        ...
        if (identificador != -1) {
            ...
            AmpliacionReduccionAccion movtoAccionListTemp = new AmpliacionReduccionAccion();
        ...
        ampliacionReduccion.setAmpReducAccionList(movtoAccionesList);
