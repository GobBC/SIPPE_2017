    ...
    try{
        ...
        if(request.getParameter("finalidad2") != null && !request.getParameter("finalidad2").equals("")){
           strFinalidad2=request.getParameter("finalidad2");
                ...
                funcionList = programaBean.getResultFuncionByYearFinalidad(year, strFinalidad1, strFinalidad2);
                strResultado += "   <option value='-1'>";
                
                strResultado += "       -- Seleccione una funcion --";
                strResultado += "   </option>";
                for(Funcion funcion : funcionList){
                    strResultado += "<option value='"+ funcion.getFuncion() +"'>";
                    strResultado +=  funcion.getFuncion() +  "-" + funcion.getDescr();
                    strResultado += "</option>";
                }
