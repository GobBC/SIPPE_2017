<%-- 
    Document   : ajaxActualizarReprogramacionMeta
...
<%
    ...
    try {
        ...
        if (session.getAttribute("reprogramacion") != null && session.getAttribute("reprogramacion") != "") {
            ...
            if (identificador != -1) {
                for (ReprogramacionMeta movtoMetaListTemp : movtoMetaList) {
        ...
        if (movtoMetaList.size() > 0) {
            ...
            for (ReprogramacionMeta movtoMetaListTemp : movtoMetaList) {
                ...
                if (contForEvalucion == 0) {
                    ...
                    minMetaId = movtoMetaListTemp.getMetaInfo().getMetaId();
                ...
                if (minMetaId > movtoMetaListTemp.getMetaInfo().getMetaId()) {
                    minMetaId = movtoMetaListTemp.getMetaInfo().getMetaId();
                }
        ...
        if (identificador != -1) {
            for (ReprogramacionMeta movtoMetaListTemp : movtoMetaList) {
                if (movtoMetaListTemp.getIdentificador() == identificador) {
                    ...
                    movtoMetaListTemp.setMetaInfo(metaInfo);
            ...
            ReprogramacionMeta movtoMetaListTemp = new ReprogramacionMeta();
        ...
        reprogramacion.setMovOficioMetaList(movtoMetaList);
