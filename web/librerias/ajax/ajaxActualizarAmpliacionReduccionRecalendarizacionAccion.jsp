<%-- 
    Document   : ajaxActualizarAmpliacionReduccionRecalendarizacionAccion
    ...
    try {
        ...
        if (movtoEstimacionList.size() > 0) {
            for (MovOficioAccionEstimacion reprogramacionTemp : movtoEstimacionList) {
                ...
                reprogramacionTemp.setPrograma(accionBean.getResultSQLgetProgramaByRamoMeta(year, ramoId, metaId));
