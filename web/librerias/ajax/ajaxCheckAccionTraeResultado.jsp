    ...
    try {
        ...
        //if (estadoAnterior > 0) {
            if (traeResultado.equals("off")) {
                // apagar parametro
                blResultado = accionBean.getResultSQLOffTraeResultadoAccion(year, ramoId, metaId,Integer.parseInt(accion));
                if (blResultado) {
                    strResult = "2";
                } else {
       ...
       // } else {
            if (traeResultado.equals("on")) {
                //encender parametro
                 blResultado = accionBean.getResultSQLOnTraeResultadoAccion(year, ramoId, metaId,Integer.parseInt(accion));
                    if (blResultado) {
                        strResult = "1";
                    } else {
