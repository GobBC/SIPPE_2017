<%-- 
    Document   : reporteLeyEgresos
    Created on : Julio 15 , 2015, 11:00:00 PM
    Author     : jarguelles
--%>
...
<html>
    ...
    <head>
        ...
        <title>Reporte Ley de Egresos </title>
    </head>
    ...
    <body>
        <div Id="TitProcess"><label >Reporte Ley de Egresos<label/></div>
        <div class="col-md-8 col-md-offset-2">
            <div class="botones-menu_bootstrap">
                <button type="button" class="btnbootstrap btn-reporte" onclick="generarReporteLeyEgresos()">
        ...
        <div class="center-div"> 
            <form id='frmActInfoRpt' action="ejecutaReporte/ejecutarReporte.jsp" target="_blank" method="POST">
                <input type="hidden" id="filename" name="filename" value="rptLeyEgresos.jasper"/> 
                ...
                <label> Página:</label>
                <input min="0" id="pagina" name="pagina" value="0" tabindex="1" type="number">
