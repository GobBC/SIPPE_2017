...
<html>
    ...
    <head>
        ...
        <title>Reporte de presupuesto de ingresos por ramo - niveles</title>
    </head>
    ...
    <body>
        <div Id="TitProcess"><label >Reporte De Ingresos Ejercicio Fiscal<label/></div>
        ...
        <div class="center-div"> 
            <form id='frmActInfoRpt' action="ejecutaReporte/ejecutarReporte.jsp" target="_blank" method="POST">
                <input type="hidden" id="filename" name="filename" value="<%="repPresupIngreso" + File.separatorChar + "RptPresupIngresoRamoPorNiveles.jasper"%>"/> 
